...
export const CATEGORIES = [
  ...
  },
  {
    ...
    emoji: '🚜',
    description: 'Tractors, sprayers, harvesters & tools',
    color: 'from-amber-500 to-orange-600',
    bg: 'bg-amber-50',
    border: 'border-amber-200',
    keywords: ['tractor', 'equipment', 'sprayer', 'plough', 'tiller', 'harvester', 'pump', 'pipe', 'drip', 'tool', 'motor', 'cutter', 'rotavator', 'auger'],
  },
  {
    id: 'fertilizers',
    label: 'Fertilizers & Nutrients',
    emoji: '🧪',
    description: 'Urea, DAP, NPK & bio-fertilizers',
    color: 'from-blue-500 to-cyan-600',
    bg: 'bg-blue-50',
    border: 'border-blue-200',
    keywords: ['fertilizer', 'urea', 'dap', 'npk', 'potash', 'compost', 'khad', 'nutrient', 'biofertilizer', 'zinc', 'sulfur'],
  },
  {
    id: 'seeds',
    label: 'Seeds & Saplings',
    emoji: '🌱',
    description: 'Certified seeds, hybrid grains & nursery saplings',
    color: 'from-emerald-500 to-green-600',
    bg: 'bg-emerald-50',
    border: 'border-emerald-200',
    keywords: ['seed', 'beej', 'sapling', 'hybrid', 'plant', 'nursery', 'graft', 'germination'],
  },
  {
    id: 'machinery',
    label: 'Heavy Agri Machinery',
    emoji: '⚙️',
    description: 'Threshers, balers, seed drills & solar pumps',
    color: 'from-slate-600 to-slate-800',
    bg: 'bg-slate-50',
    border: 'border-slate-300',
    keywords: ['machinery', 'thresher', 'baler', 'drill', 'solar', 'generator', 'combine', 'drone'],
  },
];
